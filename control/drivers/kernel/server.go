...
func (s *Kernel) AddShop(ctx context.Context, name string, creator int) (*pb.DefaultResponse, error) {
...
func (s *Kernel) GetTelegramGroupById(ctx context.Context, shopId int) (int, error) {
...
func (s *Kernel) AddQuestion(ctx context.Context, shopId int, question string) error {
	...
	groupId, err := s.GetTelegramGroupById(ctx, shopId)
	if err != nil {
		return err
	}
