...
func (t *Telegram) UpdateTelegramPart(ctx context.Context, shopId int, info *pb.OptionalBotInfo) error {
...
func (t *Telegram) CheckContextWithShopId(ctx context.Context, messageInfo *pb.TelegramMessageInfo, shopId int, role string) (int, bool, error) {
