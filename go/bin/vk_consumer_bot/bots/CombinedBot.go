...
func (cb *CombinedBot) Init(coordinator *api.KV, vkApiServer *apiServer.VkApiServer, callback func(groupId int, ts int, update longPullServer.UpdateObject), control ctrl.ControllerClient) {
