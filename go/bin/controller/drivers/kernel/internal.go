...
func (s *Kernel) UpdateShopCommonPart(ctx context.Context, shopId int, info *ctrlProto.OptionalBotInfo) error {
...
func (s *Kernel) GetShopIdByKey(ctx context.Context, key *ctrlProto.CommonShopKey) (int, error) {
	...
	case *ctrlProto.CommonShopKey_VkGroupId:
